...
#import "CDComboBoxViewController.h"
#import <MMComboBox/MMComBoBox.h>

@interface CDComboBoxViewController ()<MMComBoBoxViewDataSource, MMComBoBoxViewDelegate>
...
@implementation CDComboBoxViewController
...
- (void)respondsToButtonAction:(UIButton *)sender {
    CDComboBoxViewController *vc = [[CDComboBoxViewController alloc] init];
...
- (UIImageView *)imageView {
    if (_imageView == nil) {
        ...
        _imageView.image = [UIImage imageNamed:@"g3.jpg"];
    }
    return _imageView;
}
